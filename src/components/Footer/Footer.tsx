...
const Footer: FC<FooterProps> = () => (
  <footer data-testid="Footer" className="bg-white border-t-1 rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased mt-4">
    <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
      © {new Date().getFullYear()} {" "}
      <a href="/" className="hover:underline" target="_blank">
        {Translations['Meta:StoreName']}
      </a>
      . All rights reserved.
    </p>
    {/* <div className="flex- justify-center hidden items-center space-x-1">
      <a
        href="#"
